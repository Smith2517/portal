...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?= media(); ?>/css/style.css?version=<?= getVersion() ?>">
</head>
...
<body class="app sidebar-mini pace-done">
  ...
  <!-- Navbar-->
  <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Panel Control</a>
    <!-- Sidebar toggle button--><a class="app-sidebar__toggle" href="#" data-toggle="sidebar" aria-label="Hide Sidebar"><i class="fas fa-bars"></i></a>
    <!-- Navbar Right Menu-->
    <ul class="app-nav">
      <li>
        <a href="<?= base_url() ?>" class="app-nav__item" target="_blank" rel="noopener noreferrer"><i class="fa fa-eye"></i>&nbsp;&nbsp;Ver la Pagina</a>
      </li>
      <!-- User Menu-->
