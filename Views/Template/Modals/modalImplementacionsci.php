                        ...
                        <form id="formSave" name="formSave">
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input class="form-control" id="txtTitulo" name="txtTitulo" type="text" placeholder="Ej: Manual de Implementación SCI" required="">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" id="txtCategoria" name="txtCategoria" type="text" placeholder="Ej: Manuales, Guías, Procedimientos">
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="txtDescripcion" name="txtDescripcion" rows="4" placeholder="Descripción del documento de implementación"></textarea>
                            </div>
                        ...
                        <form id="formUpdate" name="formUpdate">
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input class="form-control" id="txtTitulo_upd" name="txtTitulo_upd" type="text" placeholder="Ej: Manual de Implementación SCI" required="">
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" id="txtCategoria_upd" name="txtCategoria_upd" type="text" placeholder="Ej: Manuales, Guías, Procedimientos">
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="txtDescripcion_upd" name="txtDescripcion_upd" rows="4" placeholder="Descripción del documento de implementación"></textarea>
                            </div>
                            <div class="tile-footer">
