                        ...
                        <form id="formSave" name="formSave">
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input class="form-control" id="txtTitulo" name="txtTitulo" type="text" placeholder="Ej: Ley N° 29812 - Ley del Servicio Civil" required="">
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="control-label" for="txtNumero">Número</label>
                                    <input class="form-control" id="txtNumero" name="txtNumero" type="text" placeholder="Ej: 29812">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" id="txtCategoria" name="txtCategoria" type="text" placeholder="Ej: Leyes, Decretos, Resoluciones">
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="txtDescripcion" name="txtDescripcion" rows="4" placeholder="Descripción del documento normativo"></textarea>
                            </div>
                        ...
                        <form id="formUpdate" name="formUpdate">
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input class="form-control" id="txtTitulo_upd" name="txtTitulo_upd" type="text" placeholder="Ej: Ley N° 29812 - Ley del Servicio Civil" required="">
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="control-label" for="txtNumero_upd">Número</label>
                                    <input class="form-control" id="txtNumero_upd" name="txtNumero_upd" type="text" placeholder="Ej: 29812">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" id="txtCategoria_upd" name="txtCategoria_upd" type="text" placeholder="Ej: Leyes, Decretos, Resoluciones">
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="txtDescripcion_upd" name="txtDescripcion_upd" rows="4" placeholder="Descripción del documento normativo"></textarea>
                            </div>
                            <div class="tile-footer">
