                        ...
                        <form id="formSave" name="formSave">
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input class="form-control" id="txtNombre" name="txtNombre" type="text" placeholder="Ej: Guía de Prevención de la Corrupción" required="">
                                </div>
                        ...
                        <form id="formUpdate" name="formUpdate">
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input class="form-control" id="txtNombre_upd" name="txtNombre_upd" type="text" placeholder="Ej: Guía de Prevención de la Corrupción" required="">
                                </div>
                                <div class="form-group col-md-4">
