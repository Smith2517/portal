...
<head>
    ...
    <title>Gobernabilidad - <?php echo nameWeb(); ?></title>
    <?php headerWeb($data); ?>
    <style>
                        ...
                        <div class="accordion" id="accordionGobernabilidad">
                            ...
                            if (isset($data['gobernabilidad']) && !empty($data['gobernabilidad'])) {
                                ...
                                foreach ($items as $item) {
                                    ...
                                    echo '</button>';
                                    echo '</h2>';
                                    echo '<div id="collapseItem' . $item['id'] . '" class="accordion-collapse collapse ' . $isActive . '" aria-labelledby="headingItem' . $item['id'] . '" data-bs-parent="#accordionGobernabilidad">';
                                ...
                                echo '<div class="alert alert-info text-center">No hay información de gobernabilidad disponible en este momento.</div>';
                            }
                            ?>
                        </div>
                    </div>
