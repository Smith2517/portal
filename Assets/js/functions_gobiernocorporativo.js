...
function loadTable() {
  table = $("#table").dataTable({
    ...
    ajax: {
      url: " " + base_url + "/Gobiernocorporativo/getGobiernocorporativo",
      dataSrc: "",
    },
    columns: [
      { data: "cont" },
    ...
    drawCallback: function() {
      // Reasignar eventos después de cada redraw
      setTimeout(() => {
        updateEstado();
        deleteDocumento();
        openModalEdit();
...
function save() {
  if (document.querySelector("#formSave")) {
    ...
    formSave.addEventListener("submit", (e) => {
      ...
      let url = base_url + "/Gobiernocorporativo/saveGobiernocorporativo";
      try {
        if (divLoading) divLoading.style.display = "flex";
        fetch(url, config)
...
function update() {
  if (document.querySelector("#formUpdate")) {
    ...
    formUpdate.addEventListener("submit", (e) => {
      ...
      let url = base_url + "/Gobiernocorporativo/updateGobiernocorporativo";
      try {
        if (divLoading) divLoading.style.display = "flex";
        fetch(url, config)
          .then((response) => response.json())
...
function updateFile() {
  if (document.querySelector("#formUpdateFile")) {
    ...
    formUpdateFile.addEventListener("submit", (e) => {
      ...
      let url = base_url + "/Gobiernocorporativo/updateFileGobiernocorporativo";
      try {
        if (divLoading) divLoading.style.display = "flex";
        fetch(url, config)
          .then((response) => response.json())
      ...
      btn.addEventListener("click", function () {
        ...
        swal({
          ...
          if (willDelete) {
            ...
            let url = base_url + "/Gobiernocorporativo/updateEstadoGobiernocorporativo";
            try {
              if (divLoading) divLoading.style.display = "flex";
              fetch(url, config)
                .then((response) => response.json())
      ...
      btn.addEventListener("click", function () {
        ...
        swal({
          ...
          if (willDelete) {
            ...
            let url = base_url + "/Gobiernocorporativo/deleteGobiernocorporativo";
            try {
              if (divLoading) divLoading.style.display = "flex";
              fetch(url, config)
                .then((response) => response.json())
