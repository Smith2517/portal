...
function loadTable() {
  table = $("#table").dataTable({
    ...
    ajax: {
      url: " " + base_url + "/Packanticorrupcion/getPackanticorrupcion",
      dataSrc: "",
    },
    columns: [
      { data: "cont" },
...
function save() {
  if (document.querySelector("#formSave")) {
    ...
    formSave.addEventListener("submit", (e) => {
      ...
      let url = base_url + "/Packanticorrupcion/savePackanticorrupcion";
      try {
        if (divLoading) divLoading.style.display = "flex";
        fetch(url, config)
...
function update() {
  if (document.querySelector("#formUpdate")) {
    ...
    formUpdate.addEventListener("submit", (e) => {
      ...
      let url = base_url + "/Packanticorrupcion/updatePackanticorrupcion";
      try {
        if (divLoading) divLoading.style.display = "flex";
        fetch(url, config)
          .then((response) => response.json())
...
function updateFile() {
  if (document.querySelector("#formUpdateFile")) {
    ...
    formUpdateFile.addEventListener("submit", (e) => {
      ...
      let url = base_url + "/Packanticorrupcion/updateFilePackanticorrupcion";
      try {
        if (divLoading) divLoading.style.display = "flex";
        fetch(url, config)
          .then((response) => response.json())
      ...
      btn.addEventListener("click", function () {
        ...
        swal({
          ...
          if (willDelete) {
            ...
            let url = base_url + "/Packanticorrupcion/updateEstadoPackanticorrupcion";
            try {
              if (divLoading) divLoading.style.display = "flex";
              fetch(url, config)
                .then((response) => response.json())
      ...
      btn.addEventListener("click", function () {
        ...
        swal({
          ...
          if (willDelete) {
            ...
            let url = base_url + "/Packanticorrupcion/deletePackanticorrupcion";
            try {
              if (divLoading) divLoading.style.display = "flex";
              fetch(url, config)
                .then((response) => response.json())
